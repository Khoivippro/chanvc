...
Visuals_Page2:Toggle('SuperFast Attack มีโอกาสโดนเตะออกจากเซิฟ ',_G.Settings.Superclick,function(value)
	_G.Settings.Superclick = value
    saveSettings()
end)
	spawn(function()
		game:GetService("RunService").RenderStepped:Connect(function()
			if _G.Settings.Superclick == true then
...
Visuals_Page2:Toggle('Auto Click',_G.Settings.Autoclick,function(value)
	_G.Settings.Autoclick = value
    saveSettings()
end)    
spawn(function()
	game:GetService("RunService").RenderStepped:Connect(function()
...
Visuals_Page2:Toggle('AntiAFK',_G.Settings.AntiAFK,function(value)
